                        ...
                        <div className="card card-lg shadow-none">
                          <div className="card-body text-center">
                            ...
                            <p className="text-muted mb-5">
                              ...
                              industry-leading tech to ensure your customers get
                              the best quality products, delivered fast. */}
                              Dreamship được thiết kế để giảm thiểu những phiền toái không cần thiết, 
            ...
            <div className="justify-content-center row">
              <div className="col-lg-8 col-md-10">
                <h2 className="display-4 text-center mb-9 mb-md-10">
                  {/* Explore why Dreamship is the right match for you. */}
                  Khám phá xem tại sao Dreamship phù hợp với bạn.
                </h2>
              </div>
            </div>
                ...
                <div className="d-flex mt-8 mt-md-9">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="font-size-sm mb-0 text-muted">
                      ...
                      forever. Dreamship enables you to move quickly, without
                      risk to your time and resources. */}
                      Cắt giảm chi phí hàng tồn kho và vận hành mãi mãi. Dreamship giúp bạn có 
